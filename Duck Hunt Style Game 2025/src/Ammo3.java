...
public class Ammo3 {
    ...
    public Ammo3() {
        ammo3 = getImage("/imgs/ammo3.png"); // Load the image file
        ammo2 = getImage("/imgs/ammo2.png");
        ammo1 = getImage("/imgs/ammo1.png");
        ammo0 = getImage("/imgs/ammo0.png");
    ...
    public Ammo3(int x, int y, int scaleX, int scaleY) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    //2nd constructor to initialize location and scale!
    public Ammo3(int x, int y, int scaleX, int scaleY, int vx, int vy) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    private Image getImage(String path) {
        ...
        try {
            URL imageURL = Ammo3.class.getResource(path);
